...
listing1 = Listing.create!(title: 'leaky pipes', budget: 14550 , description:"The pipes in my apartment have leaked and now my apartment has turned into a swimming pool. My carpet is damaged, so i need someone over here asap. Please come sooooooooon!" , image: 'http://www.propertyrepair.ie/uploads/9/2/2/6/9226934/934581_orig.jpg' , user_id: User.last.id )
...
listing5 = Listing.create!(title: 'crossed wires', budget: 4200 , description: "All the power in my house has gone out. Not sure what exactly the problem is, but be careful because prior to the blackout, it gave quite a shock!" , image: 'http://i1.trekearth.com/photos/7604/wired1.jpg', user_id: User.first.id )
